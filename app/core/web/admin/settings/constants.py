...
from app.enums import PaymentMethods # Import the Enum for consistency
...
PAYMENT_METHOD_OVERVIEW = [
    {
        ...
        "setup_url": lambda: url_for("web.web_admin.web_admin_settings.payment_setup", method=PaymentMethods.GATEWAY.value),
    },
    {
        ...
        "setup_url": lambda: url_for("web.web_admin.web_admin_settings.payment_setup", method=PaymentMethods.BACS.value),
    },
    {
        ...
        "setup_url": lambda: url_for("web.web_admin.web_admin_settings.payment_setup", method=PaymentMethods.CHECK.value),
    },
    {
        ...
        "setup_url": lambda: url_for("web.web_admin.web_admin_settings.payment_setup", method=PaymentMethods.COD.value),
    },
]